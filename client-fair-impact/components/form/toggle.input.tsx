...
export default function ToggleInput() {
  ...
  return (
    <Switch
      checked={enabled}
      onChange={setEnabled}
      className="group focus:ring-fair_dark_blue-600 data-checked:bg-fair_dark_blue-600 relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-gray-200 transition-colors duration-200 ease-in-out focus:ring-2 focus:ring-offset-2 focus:outline-hidden"
    >
      ...
      <span className="pointer-events-none relative inline-block size-5 transform rounded-full bg-white ring-0 shadow-sm transition duration-200 ease-in-out group-data-checked:translate-x-5">
        ...
        >
          <svg
            fill="currentColor"
            viewBox="0 0 12 12"
            className="text-fair_dark_blue-600 size-3"
          >
