    ...
    <>
      ...
      <main className="mx-auto max-w-7xl px-2 lg:px-8">
        <section>
          ...
          <p>
            Welcome to our application! We are dedicated to creating tools that
            promote fairness and awareness in impactful ways.
          </p>
          <p>
            Our mission is to empower individuals and organizations to make
