export const digitalObjectTypeSchemaDATA = {
  dotCLM: 'Dataset English',
  lang: 'English',
  langCode: 'en',
  dot: 'DATA',
  introSupportEmail: '',
          ...
          support: {
            ...
            more: {
              ...
              links: [
                {
                  label:
                    'Social Sciences and Humanities - Gregory, K.M. (Data Archive and Networked Services) (2020): Data Discovery and Reuse Practices in Research.',
                  link: 'https://doi.org/10.17026/dans-xsw-kkeq',
                },
                {
                  label:
                    'Life Sciences - Apriyanti, D.H., Spreeuwers, L.J., Lucas, P.J.F., & Veldhuis, R.N.J. (2020).',
                  link: 'https://doi.org/10.7910/DVN/0HNECY',
                },
                {
                  label:
                    'Natural Sciences - Klages, J. P., et al. (2019). Apatite radiogenic isotopes and ages of sediment core 2R at site PS104_20-2.',
                  link: 'https://doi.org/10.1594/PANGAEA.906168',
                },
                {
                  label:
                    'Engineering Science - Pascoe, J.A.; Usman, M., (2016). Effect of temperature on fatigue crack growth in adhesive bonds.',
                  link: 'https://doi.org/10.34894/DTRPFW',
                },
              ],
            },
          },
              ...
              links: [
                {
                  ...
                  link: 'https://bartoc.org/',
                },
                {
                  label: 'CESSDA Vocabulary Service',
                  link: 'https://vocabularies.cessda.eu/',
                },
                {
                  label: 'Linked Open Vocabularies (LOV)',
                  link: 'https://lov.linkeddata.es/dataset/lov',
                },
                {
                  label: 'OBO Foundry',
                  link: 'http://www.obofoundry.org/',
                },
                {
                  label: 'BioPortal',
                ...
                {
                  label: 'NERC Vocabulary Server',
                  link: 'https://vocab.nerc.ac.uk/',
                },
                {
                  label: 'Research Vocabulary Australia',
                  link: 'https://vocabs.ands.org.au/',
                },
                {
                  label: 'MMI Ontology Registry and Repository (ORR)',
                  link: 'https://mmisw.org/',
                },
                {
                  label: 'Industrial Ontologies Foundry (IOF)',
                  link: 'https://www.industrialontologies.org/',
                },
              ],
            },
            more: {
